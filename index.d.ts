...
export function createBot(
  options: { client: Client } & Partial<BotOptions>
): Bot;
...
export interface BotEvents {
  ...
  entityEffect: [entity: Entity, effect: Effect];
  entityEffectEnd: [entity: Entity, effect: Effect];
  playerJoined: [player: Player];
  playerUpdated: [player: Player];
  playerLeft: [entity: Player];
  blockUpdate: [oldBlock: Block | null, newBlock: Block];
  "blockUpdate:[x, y, z]": [oldBlock: Block | null, newBlock: Block | null];
  chunkColumnLoad: [entity: Vec3];
  chunkColumnUnload: [entity: Vec3];
  soundEffectHeard: [
    soundName: string,
    position: Vec3,
    volume: number,
  ...
  noteHeard: [block: Block, instrument: Instrument, pitch: number];
  pistonMove: [block: Block, isPulling: number, direction: number];
  chestLidMove: [block: Block, isOpen: number, block2: Block | null];
  blockBreakProgressObserved: [block: Block, destroyStage: number];
  blockBreakProgressEnd: [block: Block];
  diggingCompleted: [block: Block];
  diggingAborted: [block: Block];
  move: [position: Vec3];
  forcedMove: [];
  mount: [];
  ...
  resourcePack: [url: string, hash: string];
...
export interface Bot extends EventEmitter {
  ...
  on<K extends keyof BotEvents>(
    event: K,
    listener: (...args: BotEvents[K]) => Promise<void> | void
  ): this;
  on<S extends string | symbol>(
    event: Exclude<S, keyof BotEvents>,
...
declare module "node:events" {
  class EventEmitter {
    ...
    public static once<E extends EventEmitter, K extends keyof BotEvents>(
      eventEmitter: E,
      eventName: E extends Bot ? K : string
    ): Promise<E extends Bot ? BotEvents[K] : any[]>;
    public static on<E extends EventEmitter, K extends keyof BotEvents>(
      eventEmitter: E,
      eventName: E extends Bot ? K : string
    ): AsyncIterableIterator<E extends Bot ? BotEvents[K] : any>;
  }
}
